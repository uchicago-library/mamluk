...
<strong><a href="http://a2.lib.uchicago.edu/mamluk/">
...
<ul>
  ...
  <li><font size="-1">Wildcards (% and _) may be used freely. For explanations, please see 
	the <a href="http://a2.lib.uchicago.edu/mamluk/searchhelp.html">expanded search help</a> page.</font>
  </li>
  ...
  <li><font size="-1">For explanations and examples of search features, please see the <a href="http://a2.lib.uchicago.edu/mamluk/searchhelp.html">expanded search help</a> page.</font></li>
</ul>
...
mysql_select_db($db_name) or die('Could not select database');
	...
	$query = "SELECT Field1 FROM subject_list2";	
